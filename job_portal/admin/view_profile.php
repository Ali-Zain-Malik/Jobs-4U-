<?php
include("config.php");
// Receiving id through get request through the link
$user_id    = $_GET['id'];

// Getting the user data by calling getUserInfo function. 
$userData   = getUserInfo($user_id);

if($userData->success)
{
  $applicant_checked  =   ($userData->userInfo->role == 0) ? "checked" : "";
  $employer_checked   =   ($userData->userInfo->role == 1) ? "checked" : "";
  $admin_checked      =   ($userData->userInfo->role == 2) ? "checked" : "";

  $yes_topEmployer  =   ($userData->userInfo->is_top == 1) ? "checked" : "";
  $no_topEmployer   =   ($userData->userInfo->is_top == 0) ? "checked" : "";
}
else
{
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form id="edit-form" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3 d-flex align-items-center">
                      ...
                      <div class="col-md-8 col-lg-9">
                          ...
                          <input name="role" class="form-check-input" type="radio" <?php echo $employer_checked; ?> id="role-employer" value="1">
                          <label for="role-employer" class="text-dark pointer pe-3">Employer</label>
                          
                          <input name="role" class="form-check-input" type="radio" <?php echo $applicant_checked; ?> id="role-applicant" value="0">
                          <label for="role-applicant" class="text-dark pointer pe-3">Applicant</label>

                          <input name="role" class="form-check-input" type="radio" <?php echo $admin_checked; ?> id="role-admin" value="2">
                  ...
                  -->
                  <?php if($userData->userInfo->role == 1){$class="d-flex";} else $class="d-none"; ?>
                    <div class="row mb-3 <?php echo $class; ?> align-items-center">
                      <label for="top-employer" class="col-md-4 col-lg-3 col-form-label">Top Employer</label>
                      <div class="col-md-8 col-lg-9">

                          <input name="top-emp" class="form-check-input" type="radio" <?php echo $yes_topEmployer; ?> id="top-employer-yes" value="1">
                          <label for="top-employer-yes" class="text-dark pointer pe-3">Yes</label>
                          
                          <input name="top-emp" class="form-check-input" type="radio" <?php echo $no_topEmployer; ?> id="top-employer-no" value="0">
